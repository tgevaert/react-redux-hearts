...
it('Calculates scores', () => {
  ...
  state = heartsRounds(state, Object.assign({}, playCardAction, {playerID: testConstants.playerBob.id, card: testConstants.cardAH}))
  state = heartsRounds(state, Object.assign({}, playCardAction, {playerID: testConstants.playerDoug.id, card: testConstants.cardAC}))
  state = heartsRounds(state, Object.assign({}, playCardAction, {playerID: testConstants.playerBill.id, card: testConstants.card3C}))
  state = heartsRounds(state, Object.assign({}, playCardAction, {playerID: testConstants.playerTed.id, card: testConstants.card2C}))
  state = heartsRounds(state, newTrickAction);
...
it('Calculates multiple round scores', () => {
  ...
  state = heartsRounds(state, newRoundAction);
  state = heartsRounds(state, Object.assign({}, playCardAction, {playerID: testConstants.playerBob.id, card: testConstants.card2C}))
  state = heartsRounds(state, Object.assign({}, playCardAction, {playerID: testConstants.playerDoug.id, card: testConstants.card3C}))
  state = heartsRounds(state, Object.assign({}, playCardAction, {playerID: testConstants.playerBill.id, card: testConstants.cardQS}))
  state = heartsRounds(state, Object.assign({}, playCardAction, {playerID: testConstants.playerTed.id, card: testConstants.cardAC}))
  expect(fromHeartsRounds.getScores(state, players)).toEqual([[1, 0, 0, 0], [0, 0, 0, 13]]);
})
