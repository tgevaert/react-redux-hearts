...
const dealBobCardAH = Object.assign(
  {},
  { type: fromHeartsPlayers.DEAL_CARD },
  { playerID: testConstants.playerBob.id },
  { card: testConstants.cardAH }
);
const dealBobCard2H = Object.assign(
  {},
  { type: fromHeartsPlayers.DEAL_CARD },
  { playerID: testConstants.playerBob.id },
  { card: testConstants.card2H }
);
const dealBobCard3H = Object.assign(
  {},
  { type: fromHeartsPlayers.DEAL_CARD },
  { playerID: testConstants.playerBob.id },
...
const playBobCardAH = Object.assign(
  {},
...
const toggleCardAH = Object.assign(
  {},
  { type: fromHeartsPlayers.TOGGLE_CARD },
  { playerID: testConstants.playerBob.id },
  { card: testConstants.cardAH }
);
...
it('Adds a player', () => {
  expect(heartsPlayers(undefined, testConstants.addPlayerBob)).toEqual([
    Object.assign({}, testConstants.playerBob, testConstants.emptyHand)
  ]);
});
...
it('Deals a card', () => {
  ...
  expect(state).toEqual([
    Object.assign({}, testConstants.playerBob, {
      playerHand: [testConstants.cardAH]
    })
  ]);
});
...
it('Plays a card', () => {
  ...
  expect(state).toEqual([
    Object.assign({}, testConstants.playerBob, {
      playerHand: testConstants.emptyHand
    })
  ]);
});
...
it('Toggles a card', () => {
  ...
  expect(state).toEqual([
    Object.assign(
      ...
      { playerHand: [testConstants.cardAH] },
      { selectedCards: [testConstants.cardAH] }
    )
  ]);
});
...
it('Passes cards', () => {
  let state = undefined;
  let passCards = [
    testConstants.card2H,
    testConstants.card3H,
    testConstants.cardAH
  ];
  state = heartsPlayers(state, testConstants.addPlayerBob);
  ...
  state = heartsPlayers(state, {
    type: fromHeartsPlayers.PASS_CARDS,
...
it('Tests card in hand', () => {
  ...
  state = heartsPlayers(state, dealBobCardAH);
  expect(
    fromHeartsPlayers.playerHandContainsCard(
      state,
...
it('Tests suit in hand', () => {
  ...
  state = heartsPlayers(state, dealBobCardAH);
  expect(
    fromHeartsPlayers.playerHandContainsSuit(
      state,
      testConstants.playerBob.id,
      'H'
    )
